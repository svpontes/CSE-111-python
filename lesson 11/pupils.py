...
# cada linha em pupils.csv file contem 3 elementos
# Esses são os index
GIVEN_NAME_INDEX = 0
SURNAME_INDEX = 1
BIRTHDATE_INDEX = 2
...
def main():
    try:
        # Lê o arquivo pupils.csv em uma lista composta:

        students_list = read_compound_list("pupils.csv")

        # Para debugar o código, imprimir a lista de estudantes
        #print(students_list)
...
def sort_oldest_to_youngest(students_list):
    ...
    """
    # Definir a função lambda qu extrai a data de aniversário do aluno
    # 
