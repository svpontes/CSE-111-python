...
def print_death_age(people_dict):
    ...
    for person in people_dict:
        ...
        value = people_dict[person]
        people_dict[person] = value
        
        NAME_INDEX = value[0]
        GENDER_INDEX = value[1]
        BIRTH_YEAR_INDEX = value[2]
        DEATH_YEAR_INDEX = value[3]
        print()
        print(f"DOB: {BIRTH_YEAR_INDEX} Name:{NAME_INDEX}  Gender:{GENDER_INDEX} Death Year:{DEATH_YEAR_INDEX} ")
...
def count_genders(people_dict):
    male = 1
    female = 1
    for gender, value in people_dict.items():
        people_dict = value[gender]
        people_dict[gender] = value
